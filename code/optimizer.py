...
# argument에서 전달받은 name과 optimizer class를 묶는 entrypoint dictionary
...
def create_optimizer(optimizer_name, **kwargs):
    ...
    return optimizer # 전달된 인자로 정의된 optimizer return

# for testing custom optimizer
